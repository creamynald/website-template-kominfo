        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Vertical Form -->
                    <form method="post" class="row g-3" action="{{ route('kategori.store') }}">
                        @csrf
                        <div class="col-12">
                            <label for="kategori" class="form-label">Nama Kategori</label>
                            <input type="text" class="form-control" id="text"   placeholder="masukkan nama kategori" name="nama_kategori">
                        </div>
                        <div class="text-left">
